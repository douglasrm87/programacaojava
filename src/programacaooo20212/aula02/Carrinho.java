...
public class Carrinho {
	// Atributos
	final static int TAM_ESTOQUE = 100;

	private Sapato sapatoVetor[] = new Sapato[TAM_ESTOQUE];
	private int contadorSapato = 0;
	
	private Meia meiaVetor[] = new Meia[TAM_ESTOQUE];	
	private int contadoMeia = 0;
	...
	private Cinto cintoVetor[] = new Cinto[TAM_ESTOQUE];
	private int contadorCinto = 0;
	...
	private Camisa camisaVetor[] = new Camisa[TAM_ESTOQUE];
	private int contadorCamisa = 0;

	private Calca calcaVetor[] = new Calca[TAM_ESTOQUE];
	private int contadorCalca = 0;
