...
public class CaixaHeranca {
	Scanner leia = new Scanner(System.in).useDelimiter("\r\n");

	public static void main(String[] args) {
		new CaixaHeranca().processar();
	}

	private void processar() {

		CarrinhoHeranca car = new CarrinhoHeranca();
		...
		do {
			...
			case 1:
				...
				System.out.println("Digite o tipo dagla:");
				cam.setTpGola(this.leia.next());
			...
			case 7:
				...
				double valorPagar = car.fecharItensVestuario();
